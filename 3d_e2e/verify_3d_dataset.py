...
def visualize_sample(dataset_dir):
    ...
    # 2. 対応するターゲットファイルを見つける
    # 例: LIDC-IDRI-0001_AP.npy -> LIDC-IDRI-0001_voxel.npy
    patient_id = "_".join(random_image_name.split('_')[:2])
...
if __name__ == '__main__':
    ...
    try:
        with open('3d_e2e/config_3d.yaml', 'r') as f:
